let buttons = document.querySelectorAll(".btn__calc");
...
buttons.forEach((btn) => {
  btn.addEventListener("click", () => {
    ...
    // console.log(btnValue in operators);
  });
});
...
//       previewResult.toLocaleString('en-US', { maximumFractionDigits: 6 }).length < 50
//     ) {
//       divShowOperation.style.marginRight = "45px";
//     } else if (previewResult.toLocaleString('en-US', { maximumFractionDigits: 6 }).length >= 50) {
//       divShowOperation.style.marginRight = "35px";
//     } else {
//       divShowOperation.style.marginRight = "80px";
//     }

//     showOperation.textContent = `= ${previewResult.toLocaleString('en-US', { maximumFractionDigits: 6 })}`;
//   } else {
//     showOperation.textContent !== "";
//   }
// }
...
//   input.value = result.toLocaleString('en-US', { maximumFractionDigits: 6 });
